...
func connectTransaction(view utxoView, tx *btcutil.Tx, blockHeight int32, stxos *[]spentTxOut, overwrite bool) error {
...
// entries should be allowed to overwrite existing not-fully-spent entries.
func connectTransactions(view utxoView, block *btcutil.Block, stxos *[]spentTxOut, overwrite bool) error {
...
func disconnectTransactions(view utxoView, block *btcutil.Block, stxos []spentTxOut, byHashSource utxoByHashSource) error {
