...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/haiheipijuan/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/haiheipijuan/btcd/blockchain/fullblocktests
```
