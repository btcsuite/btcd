...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/dashevo/dashd-go/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/dashevo/dashd-go/blockchain/fullblocktests
```
