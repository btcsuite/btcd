...
var detailedTests = []detailedTest{
	...
	{
		name:        "invalid opcode OP_SMALLDATA if noexec",
		script:      []byte{txscript.OP_FALSE, txscript.OP_IF, txscript.OP_SMALLDATA, txscript.OP_ELSE, txscript.OP_TRUE, txscript.OP_ENDIF},
		after:       [][]byte{{0x01}},
		disassembly: "0 OP_IF OP_SMALLDATA OP_ELSE 1 OP_ENDIF",
	},
	{
		name:        "invalid opcode OP_SMALLINTEGER if noexec",
		script:      []byte{txscript.OP_FALSE, txscript.OP_IF, txscript.OP_SMALLINTEGER, txscript.OP_ELSE, txscript.OP_TRUE, txscript.OP_ENDIF},
		after:       [][]byte{{0x01}},
		disassembly: "0 OP_IF OP_SMALLINTEGER OP_ELSE 1 OP_ENDIF",
	},
	{
		name:        "invalid opcode OP_PUBKEYS if noexec",
		script:      []byte{txscript.OP_FALSE, txscript.OP_IF, txscript.OP_PUBKEYS, txscript.OP_ELSE, txscript.OP_TRUE, txscript.OP_ENDIF},
		after:       [][]byte{{0x01}},
		disassembly: "0 OP_IF OP_PUBKEYS OP_ELSE 1 OP_ENDIF",
	},
	{
	...
	{
		name:        "invalid opcode OP_PUBKEYHASH if noexec",
		script:      []byte{txscript.OP_FALSE, txscript.OP_IF, txscript.OP_PUBKEYHASH, txscript.OP_ELSE, txscript.OP_TRUE, txscript.OP_ENDIF},
		after:       [][]byte{{0x01}},
		disassembly: "0 OP_IF OP_PUBKEYHASH OP_ELSE 1 OP_ENDIF",
	},
	{
		name:        "invalid opcode OP_PUBKEY if noexec",
		script:      []byte{txscript.OP_FALSE, txscript.OP_IF, txscript.OP_PUBKEY, txscript.OP_ELSE, txscript.OP_TRUE, txscript.OP_ENDIF},
		after:       [][]byte{{0x01}},
		disassembly: "0 OP_IF OP_PUBKEY OP_ELSE 1 OP_ENDIF",
	},
	{
		name:        "invalid opcode OP_INVALIDOPCODE if noexec",
		script:      []byte{txscript.OP_FALSE, txscript.OP_IF, txscript.OP_INVALIDOPCODE, txscript.OP_ELSE, txscript.OP_TRUE, txscript.OP_ENDIF},
		after:       [][]byte{{0x01}},
		disassembly: "0 OP_IF OP_INVALIDOPCODE OP_ELSE 1 OP_ENDIF",
	},
}
