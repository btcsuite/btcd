...
A quick overview of the major features peer provides are as follows:
 ...
 - Flexible peer configuration
   - Caller is reponsible for creating outgoing connections and listening for
 ...
 - Helper functions pushing addresses, getblocks, getheaders, and reject
   messages
   - These could all be sent manually via the the standard message output
     function, but the helpers provide additional nice functionality such as
     duplicate filtering and address randomization
