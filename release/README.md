...
For example (taken from [f3ec130](https://github.com/dashevo/dashd-go/commit/f3ec13030e4e828869954472cbc51ac36bee5c1d)):
```diff
...
1. `git clone https://github.com/dashevo/dashd-go.git`
2. `cd btcd`
...
which roughly follow the format of [previous release notes](https://github.com/dashevo/dashd-go/releases/tag/v0.20.1-beta).
...
6. Obtain a copy of `btcd`'s source code with `git clone
   https://github.com/dashevo/dashd-go` and checkout the source code of the
