...
var (
	...
	// can have for the fresh network (version 3).  It is the value ^224 - 1.
...
// FreshNetParams defines the network parameters for the fresh Bitcoin network.
var FreshNetParams = Params{
	Name: "freshnet",
	Net: wire.FreshNet,
	// need to define a port num so that peers can communicate in different networks by looking at the
	// port num (for now it's randomly assigned)
	DefaultPort: "28333",
	// seed nodes left blank
	DNSSeeds: []DNSSeed{},
