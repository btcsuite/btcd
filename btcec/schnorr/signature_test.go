...
var bip340TestVectors = []bip340Test{
	// When auxRand is not passed by the caller, it should be equivalent to
	// passing an array of 32 zeroed bytes, bip340 allows this and
	// libsecp256k1 effectively uses this approach
	//
	// references:
	// https://github.com/bitcoin/bips/blob/40cd7b4dd6dae2d9d38162b019ba588839331ba1/bip-0340.mediawiki?plain=1#L161
	// https://github.com/bitcoin-core/secp256k1/blob/0f4a7e6bf9d971addb2b851df7cd2777fc62b212/include/secp256k1_schnorrsig.h#L113-L117
	{
	...
	// The following tests assert that message length does not need to be
	// 32 bytes, as stated in BIP340
	//
	// (https://github.com/bitcoin/bips/blob/40cd7b4dd6dae2d9d38162b019ba588839331ba1/bip-0340.mediawiki?plain=1#L231-L233)
	{
