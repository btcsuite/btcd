...
func TestSignatures(t *testing.T) {
	for _, test := range signatureTests {
		...
		var s *Signature
		if test.der {
			s, err = ParseDERSignature(test.sig, S256())
		} else {
			s, err = ParseSignature(test.sig, S256())
		}
		if err != nil {
			if test.isValid {
...
func TestSignatureSerialize(t *testing.T) {
	tests := []struct {
		...
		// 0437cd7f8525ceed2324359c2d0ba26006d92d85
		{
			...
			&Signature{
				R: new(nfieldVal).SetHex("4e45e16932b8af514961a1d3a1a25fdf3f4f7732e9d624c6c61548ab5fb8cd41"),
				S: new(nfieldVal).SetHex("181522ec8eca07de4860a4acdd12909d831cc56cbbac4622082221a8768d1d09"),
			},
			[]byte{
		...
		// cb00f8a0573b18faa8c4f467b049f5d202bf1101d9ef2633bc611be70376a4b4
		{
			...
			&Signature{
				R: new(nfieldVal).SetHex("82235e21a2300022738dabb8e1bbd9d19cfb1e7ab8c30a23b0afbb8d178abcf3"),
				S: new(nfieldVal).SetHex("24bf68e256c534ddfaf966bf908deb944305596f7bdcc38d69acad7f9c868724"),
			},
			[]byte{
		...
		// fda204502a3345e08afd6af27377c052e77f1fefeaeb31bdd45f1e1237ca5470
		{
			...
			&Signature{
				R:       new(nfieldVal).SetHex("1cadddc2838598fee7dc35a12b340c6bde8b389f7bfd19a1252a17c4b5ed2d71"),
				S:       new(nfieldVal).SetHex("c1a251bbecb14b058a8bd77f65de87e51c47e95904f4c0e9d52eddc21c1415ac"),
				SNegPad: true,
			},
			[]byte{
...
func TestSignCompact2(t *testing.T) {
	...
	for i, dataStr := range datum {
		...
		testSignCompact(t, fmt.Sprintf("%d 0", i), S256(), data, true)
		testSignCompact(t, fmt.Sprintf("%d 1", i), S256(), data, false)
	}
}
...
func TestSignatureIsEqual(t *testing.T) {
	sig1 := &Signature{
		R: new(nfieldVal).SetHex("0082235e21a2300022738dabb8e1bbd9d19cfb1e7ab8c30a23b0afbb8d178abcf3"),
		S: new(nfieldVal).SetHex("24bf68e256c534ddfaf966bf908deb944305596f7bdcc38d69acad7f9c868724"),
	}
	sig2 := &Signature{
		R: new(nfieldVal).SetHex("4e45e16932b8af514961a1d3a1a25fdf3f4f7732e9d624c6c61548ab5fb8cd41"),
...
func TestVerify(t *testing.T) {
	...
	for i, test := range tests {
		sig := &Signature{
			R: new(nfieldVal).SetByteSlice(test.r),
			S: new(nfieldVal).SetByteSlice(test.s),
		}
