...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/dashevo/dashd-go/integration/rpctest)
...
```bash
$ go get -u github.com/dashevo/dashd-go/integration/rpctest
```
