...
It has these top-level messages:
	...
	GetUnspentTransactionOutputSetRequest
...
type GetUnspentTransactionOutputSetRequest struct {
	// In order to communicate the block hash at which the UTXO set is streamed,
	// the caller can provide the latest block hash at the time of calling and
	// this method will fail if that hash is already outdated when the stream
	// starts.  If the caller is not care about the block the UTXO set
	// corresponds to, he can ignore this argument.
...
func (m *GetUnspentTransactionOutputSetRequest) Reset()         { *m = GetUnspentTransactionOutputSetRequest{} }
func (m *GetUnspentTransactionOutputSetRequest) String() string { return proto.CompactTextString(m) }
func (*GetUnspentTransactionOutputSetRequest) ProtoMessage()    {}
func (*GetUnspentTransactionOutputSetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{60}
}

func (m *GetUnspentTransactionOutputSetRequest) GetLatestBlockHash() []byte {
	if m != nil {
...
func (*GetAddressTransactionsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{61} }
...
func (*GetAddressTransactionsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{62} }
...
func (*SubmitBlockRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{65} }
...
func (*SubmitBlockResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{66} }
...
func (*SubscribeBlocksRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{67} }
...
func (*SubscribeTransactionsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{68} }
...
func init() {
	...
	proto.RegisterType((*GetUnspentTransactionOutputSetRequest)(nil), "btcrpc.GetUnspentTransactionOutputSetRequest")
...
type BtcdClient interface {
	...
	// Stream the entire UTXO set.
	// In order to communicate the block hash at which the UTXO set is streamed,
	// the caller can provide the latest block hash at the time of calling and
	// this method will fail if that hash is already outdated when the stream
	// starts.  If the caller is not care about the block the UTXO set
	// corresponds to, he can ignore this argument.
	GetUnspentTransactionOutputSet(ctx context.Context, in *GetUnspentTransactionOutputSetRequest, opts ...grpc.CallOption) (Btcd_GetUnspentTransactionOutputSetClient, error)
...
func (c *btcdClient) GetUnspentTransactionOutputSet(ctx context.Context, in *GetUnspentTransactionOutputSetRequest, opts ...grpc.CallOption) (Btcd_GetUnspentTransactionOutputSetClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Btcd_serviceDesc.Streams[1], c.cc, "/btcrpc.btcd/GetUnspentTransactionOutputSet", opts...)
	if err != nil {
		return nil, err
	}
	x := &btcdGetUnspentTransactionOutputSetClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Btcd_GetUnspentTransactionOutputSetClient interface {
	Recv() (*UnspentOutput, error)
	grpc.ClientStream
}

type btcdGetUnspentTransactionOutputSetClient struct {
	grpc.ClientStream
}

func (x *btcdGetUnspentTransactionOutputSetClient) Recv() (*UnspentOutput, error) {
	m := new(UnspentOutput)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *btcdClient) SubscribeBlocks(ctx context.Context, in *SubscribeBlocksRequest, opts ...grpc.CallOption) (Btcd_SubscribeBlocksClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Btcd_serviceDesc.Streams[3], c.cc, "/btcrpc.btcd/SubscribeBlocks", opts...)
	if err != nil {
		return nil, err
	}
...
type BtcdServer interface {
	...
	// starts.  If the caller is not care about the block the UTXO set
	// corresponds to, he can ignore this argument.
	GetUnspentTransactionOutputSet(*GetUnspentTransactionOutputSetRequest, Btcd_GetUnspentTransactionOutputSetServer) error
	// Returns all known transactions for the given address.
	//
	// This method requires the address and transaction index.
...
func _Btcd_GetUnspentTransactionOutputSet_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetUnspentTransactionOutputSetRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BtcdServer).GetUnspentTransactionOutputSet(m, &btcdGetUnspentTransactionOutputSetServer{stream})
}

type Btcd_GetUnspentTransactionOutputSetServer interface {
	Send(*UnspentOutput) error
	grpc.ServerStream
}

type btcdGetUnspentTransactionOutputSetServer struct {
	grpc.ServerStream
}

func (x *btcdGetUnspentTransactionOutputSetServer) Send(m *UnspentOutput) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Btcd_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetUnspentTransactionOutputSet",
			Handler:       _Btcd_GetUnspentTransactionOutputSet_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
