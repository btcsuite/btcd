...
|8|[version](#version)|Y|Returns the JSON-RPC API version.|
|9|[getheaders](#getheaders)|Y|Returns block headers starting with the first known block hash from the request.|
