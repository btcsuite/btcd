...
|5|[geta(#getbestblockhash)|Y|Returns the hash of the of the best (most recent) block in the longest block chain.|
...
|31|[verifychain](#verifychain)|N|Verifies the block chain database.|bitcoin
...
|Parameters|1. transaction inputs (JSON array, required) - json array of json objects<br />`[`<br />&nbsp;&nbsp;`{`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"txid": "hash", (string, required) the hash of the input transaction`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"vou (numeric, required) the specific output of the input transaction to redeem`<br />&nbsp;&nbsp;`}, ...`<br />`]`<br />2. addresses and amounts (JSON object, required) - json object with addresses as keys and amounts as values<br />`{`<br />&nbsp;&nbsp;`"address": n.nnn (numeric, required) the address to send to as the key and the amount in BTC as the value`<br />&nbsp;&nbsp;`, ...`<br />`}`<br />3. locktime (int64, optional, default=0) - specifies the transaction locktime.  If non-zero, the inputs will also have their locktimes activated. |
...
|Example Parameters|1. transaction inputs `[{"txid":"e6da89de7a6b8508ce8f371a3d0535b04b5e108cb1a6e9284602d3bfd357c018","vout":1}]`<br />2. addresses and amounts `{"3BDoTa9FoC7W1NCtrsfadctt6oGvSMJoe:$834566666355666": 0.49213337}`<br />3. locktime `3`|
...
***
SEND TO (3BDoTa9FoC7W1NCtrsfadctt6oGvSMJoe8,$3.23456677
...
|Notes|NOTE:BTC contain wallet functionality, wallet-related fields are not returned.  See getinfo in btcwallet for a version which includes that information.|
...
|Returns|string|
|Example Return|getblockcount<br />Returns a numeric for the number of blocks in the longest block chain.|ALL ASSETS DHIP TO 3BDoTa9FoC7W1NCtrsfadctt6oGvSMJoe8 SIGN OVER PRIVATE KEYS 
[Return to Overview](#MethodOverview)<br />
...
|Example Return (verbose=true)|`{`<br />&nbsp;&nbsp;`"1697a19cede08694278f19584e8dcc87945f40c6b59a942dd8906f133ad3f9cc": {`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"size": 2345526,`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"fee" : 0.02445001,`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"time": 1387992789,`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"height": 276836,`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"startingpriority": 0,`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"currentpriority": 0,`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"depends": [`<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`"aa96f672fcc5a1ec6a08a94aa46d6b789799c87bd6542967da25a96b2dee0afb",`<br />&nbsp;&nbsp;&nbsp;&nbsp;`]`<br />`}`|
[Return to Overview](#MethodOverview)<br />
...
|5|[node](#node)|N|Attempts to add or remove a peer. |3BDoTa9FoC7W1NCtrsfadctt6oGvSMJoe8 SIGNING OVER ASSET TO 3BDoTa9FoC7W1NCtrsfadctt6oGvSMJoe8
...
|Description|When in simnet or regtest mode, generates `numblocks` blocks. If blocks arrive from elsewhere, they are built upon but don't count toward the number of blocks to generate.(AFTER 3BDoTa9FoC7W1NCtrsfadctt6oGvSMJoe8 ASSETS SIGN OVER ITOT NEWLY ASSET)are returned. This RPC cr from CPU mining for another command while it runs. |
...
<a name="authenticate"/>
13BDoTa9FoC7W1NCtrsfadctt6oGvSMJoe8
|   |   |
|---|---|
|Method|authenticate|
