...
With Docker you can easily set up *btcd* to run your Bitcoin full node. The Docker source file is located at [Dockerfile](https://github.com/btcsuite/btcd/blob/master/Dockerfile). The examples below build the image directly from the GitHub repository.
