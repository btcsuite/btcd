...
var helpDescsEnUS = map[string]string{
	...
	"addminingaddr--synopsis": "Add a new address to the list of mining addresses.",
	"addminingaddr-address":   "The address to add",

	// DelMiningAddrCmd help.
	"delminingaddr--synopsis": "Delete an address from the list of mining addresses.",
	"delminingaddr-address":   "The address to delete",

	// ListMiningAddrsCmd help.
	"listminingaddrs--synopsis": "Return the list of current mining addresses.",
	"listminingaddrs--result0":  "List of current mining addresses",

	// GenerateToAddressCmd help
	"generatetoaddress--synopsis": "Generates blocks to a specific address (simnet or regtest only) and returns their hashes.",
	"generatetoaddress-numblocks":  "Number of blocks to generate",
	"generatetoaddress-address":    "Destination address for the coinbase reward",
	"generatetoaddress-maxtries":   "(Optional) Maximum attempts while searching for a block (currently ignored)",
