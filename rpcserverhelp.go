...
var helpDescsEnUS = map[string]string{
	...
	"generatetoaddress--synopsis": "Generates a set number of blocks (simnet or regtest only), paying the block reward to the specified address and returns a JSON\n" +
		" array of their hashes.",
	"generatetoaddress-numblocks": "Number of blocks to generate",
	"generatetoaddress-address":   "The address to send the newly generated bitcoin",
	"generatetoaddress-maxtries":  "How many iterations to try",
