...
var helpDescsEnUS = map[string]string{
	...
	"verifytxoutproof--synopsis": "Verifies that a proof points to a transaction in a block, returning " +
		"the transaction it commits to or returning an RPC error if the block is not in our best chain.",
	"verifytxoutproof-proof": "The hex-encoded proof generated by gettxoutproof",

	// VerifyTxOutProofResult help.
	"verifytxoutproofresult-txids": "The txid(s) which the proof commits to, or empty array if the proof can not be validated.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"verifytxoutproof":      {(*btcjson.VerifyTxOutProofResult)(nil)},
	"node":                  nil,
