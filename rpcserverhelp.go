...
var helpDescsEnUS = map[string]string{
	...
	"getvoteinforesult-stakeversion":  "Selected stake version.",
	...
	"agenda-totalvotes":               "Total votes in agenda.",
	"agenda-status":                   "Aganda status.",
	"agenda-quorumpercentage":         "Percentage of quorum reached.",
	...
	"choice-percentage":               "Percentage of the overall count.",
