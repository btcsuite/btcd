...
// testHash is a sha256 hash value used to pad expressions to a given script
// size or op count.
const testHash = "926a54995ca48600920a19bf7bc502ca5f2f7d07e6f804c4f00ebf" +
	"0325084dbc"
...
func TestParseRejectsInsane(t *testing.T) {
	...
	tests := []struct {
		...
		// strip the other one and change the txid.
		name:   "malleable",
